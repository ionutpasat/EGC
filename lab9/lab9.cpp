...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    {   
        glm::vec3 pos = GetSceneCamera()->m_transform->GetWorldPosition();
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(0.0f, 0.5f, 0.0f));
        modelMatrix = glm::rotate(modelMatrix, atan2(pos.x, pos.z), glm::vec3(0, 1, 0));
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3.5f, 1.5f, 0.0f));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.5f));
