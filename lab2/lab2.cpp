...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0,  2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
            VertexFormat(glm::vec3(2, 0,  2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 2,  2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            ...
            VertexFormat(glm::vec3(2, 0,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 2,  0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // by definition!
        ...
        {
            VertexFormat(glm::vec3(0, 3,  0), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1.5f, 0,  1.5f), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  -2), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1.5f, 0,  1.5f), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6))
    ...
    // opposing vertex orientations.
        {
            ...
            {
                0, 3, 2,    // indices for first triangle
        ...
        
        {
            vector<VertexFormat> vertices3
            {
               ...
               VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.583f,  0.771f,  0.014f)),
               VertexFormat(glm::vec3(0, 1, 1),  glm::vec3(0.583f,  0.771f,  0.014f)),
               VertexFormat(glm::vec3(1, 1, 1),  glm::vec3(0.583f,  0.771f,  0.014f)),
               VertexFormat(glm::vec3(1, 1, 0),  glm::vec3(0.583f,  0.771f,  0.014f)),
            ...
            //  meshes["square"]->InitFromData(vertices2, indices2);
            CreateMesh("cub_C", vertices3, indices3);
        }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-2.5f, 0.5f, 1), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(3, 0, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1, 0, 3), glm::vec3(0.25f));

    RenderMesh(meshes["cub_C"], shaders["VertexColor"], glm::vec3(-2.9f, 2.5f, 1.9), glm::vec3(0.25f));
